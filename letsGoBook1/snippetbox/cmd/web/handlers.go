...
import (
	...
	"snippetbox.glyphsmiths.com/internal/validator"
	"strconv"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Title, 100), "title", "This field cannotbe more than 100 charecters long")
	form.CheckField(validator.NotBlank(form.Title), "content", "This field cannot be blank")
	form.CheckField(validator.PermittedValues(form.Expires, 1, 7, 365), "expires", "This field must be equal to 1 or 7 or 365.")
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		data := app.newTemplateData(r)
		data.Form = form
		app.render(w, r, http.StatusUnprocessableEntity, "signup.templ", data)
		return
	}
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), "flash", "You've been logged outsuccessfully!")
