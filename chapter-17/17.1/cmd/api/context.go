...
// The contextSetUser() method returns a new copy of the request iwth the provided
...
// value in the contet, and if it doesn't exist it will firmly be an 'unexpected' error.
